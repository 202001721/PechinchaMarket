...
WebUI.click(findTestObject('Object Repository/Page_Agrupamentos - PechinchaMarket/div_Adicionar_Lista'))
...
WebUI.click(findTestObject('Object Repository/Page_Agrupamentos - PechinchaMarket/checkbox_lista-Sexta-feira'))

WebUI.click(findTestObject('Object Repository/Page_Agrupamentos - PechinchaMarket/input_remover_Lista'))
