...
WebUI.click(findTestObject('Object Repository/Page_Agrupamentos - PechinchaMarket/button_Criar_Agrupamento'))

WebUI.click(findTestObject('Object Repository/Page_Agrupamentos - PechinchaMarket/div_Agrupamento 3'))

WebUI.click(findTestObject('Object Repository/Page_Agrupamentos - PechinchaMarket/div_Eliminar Agrupamento'))

WebUI.click(findTestObject('Object Repository/Page_Agrupamentos - PechinchaMarket/button_Eliminar Agrupamento'))
