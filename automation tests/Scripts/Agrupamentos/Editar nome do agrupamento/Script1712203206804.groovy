...
WebUI.click(findTestObject('Object Repository/Page_Agrupamentos - PechinchaMarket/div_Agrupamento'))

WebUI.click(findTestObject('Object Repository/Page_Agrupamentos - PechinchaMarket/div_Agrupamento_Renomear'))

WebUI.setText(findTestObject('Object Repository/Page_Agrupamentos - PechinchaMarket/input_Agrupamento_nome'), 'Agrupamento:P ')

WebUI.click(findTestObject('Object Repository/Page_Agrupamentos - PechinchaMarket/button_Save_Nome'))
