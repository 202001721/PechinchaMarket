...
WebUI.click(findTestObject('Object Repository/Page_Perfil - PechinchaMarket/div_Editar_Foto'))

WebUI.click(findTestObject('Object Repository/Page_Perfil - PechinchaMarket/span_photo-option-1'))

WebUI.click(findTestObject('Object Repository/Page_Perfil - PechinchaMarket/button_change-photo'))

WebUI.click(findTestObject('Object Repository/Page_Perfil - PechinchaMarket/div_Editar_Foto'))

WebUI.click(findTestObject('Object Repository/Page_Perfil - PechinchaMarket/span_photo-option-2'))
