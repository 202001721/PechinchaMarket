...
WebUI.click(findTestObject('Page_Profil - PechinchaMarket/div_Salvar                                Editar'))

WebUI.setText(findTestObject('Object Repository/Page_Profil - PechinchaMarket/input_Editar_Input.UserPhone'), '123456785')

WebUI.click(findTestObject('Page_Profil - PechinchaMarket/button_Salvar'))
