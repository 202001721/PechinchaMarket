...
WebUI.click(findTestObject('Object Repository/Page_Perfil - PechinchaMarket/div_Editar_Password'))

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Perfil - PechinchaMarket/input_OldPassword'), 'VyCYYIKrGZmyN9bkhIcWmA==')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Perfil - PechinchaMarket/input_NewPassword'), 'VyCYYIKrGZmyN9bkhIcWmA==')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Perfil - PechinchaMarket/input_ConfirmPassword'), 'VyCYYIKrGZmyN9bkhIcWmA==')
