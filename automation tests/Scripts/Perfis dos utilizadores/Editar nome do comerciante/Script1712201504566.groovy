...
WebUI.click(findTestObject('Object Repository/Page_Perfil - PechinchaMarket/div_Editar_Nome'))

WebUI.setText(findTestObject('Object Repository/Page_Perfil - PechinchaMarket/input_name'), 'Comerciante:P')

WebUI.click(findTestObject('Object Repository/Page_Perfil - PechinchaMarket/button_Salvar_Nome'))
