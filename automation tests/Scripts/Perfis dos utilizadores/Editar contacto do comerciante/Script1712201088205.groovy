...
WebUI.click(findTestObject('Page_Perfil - PechinchaMarket/div_Editar_Phone'))

WebUI.setText(findTestObject('Object Repository/Page_Perfil - PechinchaMarket/input_UserPhone'), '123456785')

WebUI.click(findTestObject('Page_Perfil - PechinchaMarket/button_Salvar_Numero'))
