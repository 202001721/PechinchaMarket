...
WebUI.click(findTestObject('Object Repository/Page_Perfil - PechinchaMarket/div_Editar_Email'))

WebUI.setText(findTestObject('Object Repository/Page_Perfil - PechinchaMarket/input_Email'), 'comerciantepecmk222313123132@gmail.com')

WebUI.click(findTestObject('Object Repository/Page_Perfil - PechinchaMarket/button_Salvar_Email'))
