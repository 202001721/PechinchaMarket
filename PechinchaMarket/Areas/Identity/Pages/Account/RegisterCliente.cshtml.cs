...
namespace PechinchaMarket.Areas.Identity.Pages.Account
{
    public class RegisterClienteModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [StringLength(100, ErrorMessage = "A password não é válida", MinimumLength = 6)]
            ...
            [Compare("Password", ErrorMessage = "A password e a confirmação da password não são a mesma.")]
